...
class InstagramService:
    ...
    def get_user_insights(self, params, period='day'):
        """
        ***********************************************************************************
        【APIエンドポイント】
    ...
    def get_user_business_discovery(self, params):
        ...
        ***********************************************************************************
        ...
        Params['access_token'] = params['access_token']
        Params[
            'fields'] = 'business_discovery.username(' + params['user_name'] + '){followers_count,media_count,media{comments_count,like_count}}'
        # エンドポイントURL
        url = params['endpoint_base'] + Params['user_id']
        # 出力
        return self.api_call(url, Params, 'GET')
